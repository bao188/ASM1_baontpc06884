(function($) {
  ...
  $(function() {
    ...
    if ($("#sales-chart").length) {
      ...
      document.getElementById('sales-legend').innerphp = SalesChart.generateLegend();
    }
    ...
    if ($("#north-america-chart").length) {
      ...
      document.getElementById('north-america-legend').innerphp = northAmericaChart.generateLegend();
    }
